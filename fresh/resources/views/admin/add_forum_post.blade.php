...
<div id="main-content">
        <div class="container-fluid">
            ...
            <div class="block-header">
                ...
                @endif
                <form method="post"  enctype="multipart/form-data" action="{{url('admin/save/forum/post')}}">
                    @csrf
                <div class="row clearfix">
                <div class="col-lg-6 col-md-12">
                    <label>Enter Post Title</label>
                    <div class="input-group mb-3">
                         <input required type="text" class="form-control" name="title" placeholder="Enter Post Title">
                     </div> 
                </div>
                <div class="col-lg-6 col-md-12">
                    <div>
